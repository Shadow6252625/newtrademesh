...
function LiquidButton({
    ...
    return (
        <>
            ...
            >
                {/* Rotating Glow Layer */}
                <div className="absolute -inset-1 rounded-full animate-glow-rotate opacity-40 blur-md pointer-events-none z-[-1]"
                    style={{
                        background: "conic-gradient(from 0deg, transparent 0%, #22d3ee 25%, transparent 50%, #22d3ee 75%, transparent 100%)"
                    }}
                />
